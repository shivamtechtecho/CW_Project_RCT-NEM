    ...
    <>
      ...
      <div className="landing-page">
        ...
        <div className="hero-section" style={{ color: theme === "dark" ? "darkgreen" : "darkblue" }}>
          <h1 className="main-title"> T<span className="highlight-r">R</span>EZEN</h1>
            ...
            <div className="content-text1">
              <p style={{color:"black", fontSize:"20px"}}>
                <a href="#" className="link-title1">
                  <br />
                  <b>Trezen</b>: A Journey to Remember
                </a>{" "}
                Nestled in the heart of Himachal Pradesh, Trezen was born out of a passion for travel and a deep love for the majestic landscapes of the Himalayas. Since its inception, the company has been dedicated to providing travelers with unforgettable experiences that combine adventure, comfort, and cultural immersion.

                With years of expertise in the travel industry, Trezen has grown to become a trusted name for those seeking seamless and personalized journeys. The company takes pride in offering tailor-made travel packages that cater to diverse needs, whether it’s a peaceful retreat in the hills, an adrenaline-filled adventure, or a journey to explore the vibrant culture of the region.

                Trezen has its roots firmly planted in the Himalayan soil, making it the perfect guide for exploring iconic destinations such as Shimla, Manali, Spiti, Lahaul, and Kullu. Every trip is thoughtfully crafted to ensure travelers experience the raw beauty and charm of these places. From booking affordable rail and air tickets to arranging comfortable accommodations and transport, Trezen ensures that every detail is taken care of, leaving travelers free to soak in the joy of the journey.
                ...
                At Trezen, travel isn’t just about reaching a destination; it’s about creating memories that last a lifetime. With a commitment to exceptional service and a passion for showcasing the beauty of Himachal Pradesh, Trezen invites you to embark on a journey that you’ll treasure forever.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="destination-section2" style={{ backgroundColor: theme === "dark" ? "black" : "white", color: theme === "dark" ? "darkred" : "black" }}>
          ...
          <div className="destination-card">
            <img
              ...
              className="card-image"
            />
            <h3 className="card-text" style={{ color: theme === "dark" ? "darkred" : "black" }}>JAMMU & KASHMIR</h3>
          </div>
          </Link>
          <Link to="/kullu">
          <div className="destination-card">
